...
from fn_imports.fire_store import add_data, delete_old_data
...
def test_delete_old_data_integration():
    """
    ...
    dummy_data = {"test_field": "delete me"}
